...
##Crear dirección para nodo en puerto 5000, particularmente para la transaccion
...
def mineBlock():
    ...
    ##Agregar transacciones
    blockchain.addTransaction(sender = nodeAddress, receiver = 'Onnee', amount = 1000)
...
##Aplicar consenso y ver cual es la cadena mas larga
